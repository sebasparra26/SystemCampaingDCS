...
MS.CONFIG = MS.CONFIG or {
    ...
    rootRelativePath = "Scripts\\HorizontDev\\KOLA\\",
    jsonRelativePath = "Config\\HorizontDev\\KOLA\\SystemMissionPersistenceKola.json",
    ...
    warehouseJsonRelativePaths = {
        "Config\\HorizontDev\\KOLA\\SistemWarehousePersistanceKola.json",
        "Config\\HorizontDev\\KOLA\\SistemWarehousePersistanceKola.json",
    },
