...
-- VERSION: 1.2
-- Nucleo limpio del marketplace logistico
-- Sin UI F10 interna. El menu vive en HDEV_MarketplaceMenuF10.lua
-- ============================================================================
...
----------------------------------------------------------------
-- CORE COST API
-- Esta funcion queda en el core porque requestDelivery la usa.
-- El menu F10 tiene su propia copia para pintar labels/precios.
----------------------------------------------------------------
