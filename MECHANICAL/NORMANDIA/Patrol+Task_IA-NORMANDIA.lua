...
local PATROL_DEFINITIONS = {
    {
        name = "PATRULLA_THIRDREICH",
        templates = { "Patrol_IA_THIRDREICH_1", "Patrol_IA_THIRDREICH_2" },
    ...
    {
        name = "PATRULLA_THIRDREICH_1",
        templates = { "Patrol_IA_THIRDREICH_3", "Patrol_IA_THIRDREICH_4" },
        clonePrefix = "THIRDREICH air ",
        activationFlag = 150,
        activationValue = 1,
        ownCoalition = coalition.side.RED,
    ...
    {
        name = "PATRULLA_THIRDREICH_2",
        templates = { "Patrol_IA_THIRDREICH_5", "Patrol_IA_THIRDREICH_6" },
        clonePrefix = "THIRDREICH air ",
        activationFlag = 118,
        activationValue = 1,
        ownCoalition = coalition.side.RED,
        ...
        {
        name = "PATRULLA_THIRDREICH_3",
        templates = { "Patrol_IA_THIRDREICH_7"},
        clonePrefix = "THIRDREICH air ",
        activationFlag = 158,
        activationValue = 1,
        ownCoalition = coalition.side.RED,
        ...
        debug = DEFAULT_DEBUG
            ...
            {
        name = "PATRULLA_THIRDREICH_4",
        templates = { "Patrol_IA_THIRDREICH_8", "Patrol_IA_THIRDREICH_9"},
        clonePrefix = "THIRDREICH air ",
        activationFlag = 156,
        activationValue = 1,
        ownCoalition = coalition.side.RED,
