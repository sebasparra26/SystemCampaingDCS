...
local PATROL_DEFINITIONS = {
    ...
    { --AVIONES
     ...
     { --HELIS
        name = "PATRULLA_ABKHAZIA_HELIS",
        templates = { "Patrol_IA_ABKHAZIA_1_HELIS", "Patrol_IA_ABKHAZIA_2_HELIS" },
        clonePrefix = "ABKHAZIA hel ",
        activationFlag = 120,
        activationValue = 1,
        ownCoalition = coalition.side.RED,
        enemyCoalition = coalition.side.BLUE,
     ...
     {
        name = "PATRULLA_BELARUS",
        templates = { "Patrol_IA_BELARUS_1", "Patrol_IA_BELARUS_2"},
        ...
        enemyUnitIndex = 1,
        monitorUnitIndex = 1,
        detectionRange = 35 * NM_TO_METERS,
        engageRange = 25 * NM_TO_METERS,
        altitudeArm = DEFAULT_ALTITUDE_ARM,
        stopSpeed = DEFAULT_STOP_SPEED,
        allowedCategories = CATEGORY_SETS.AIR_ONLY,
        debug = DEFAULT_DEBUG
     ...
     {
        name = "PATRULLA_CHINA",
        templates = { "Patrol_IA_CHINA_1", "Patrol_IA_CHINA_2"},
        clonePrefix = "CHINA air ",
        activationFlag = 109,
        activationValue = 1,
        ownCoalition = coalition.side.RED,
        enemyCoalition = coalition.side.BLUE,
        ...
        enemyUnitIndex = 1,
        monitorUnitIndex = 1,
        detectionRange = 50 * NM_TO_METERS,
        engageRange = 40 * NM_TO_METERS,
        altitudeArm = DEFAULT_ALTITUDE_ARM,
        stopSpeed = DEFAULT_STOP_SPEED,
        allowedCategories = CATEGORY_SETS.AIR_ONLY,
        debug = DEFAULT_DEBUG
    ...
    { -- AVIONES
        name = "PATRULLA_IRAN",
        templates = { "Patrol_IA_IRAN_1"},
        clonePrefix = "IRAN air ",
        activationFlag = 127,
        activationValue = 1,
        ownCoalition = coalition.side.RED,
        enemyCoalition = coalition.side.BLUE,
    ...
    { -- HELIS
        name = "PATRULLA_IRAN_HELIS",
        templates = { "Patrol_IA_IRAN_1_HELIS", "Patrol_IA_IRAN_2_HELIS"},
        clonePrefix = "IRAN hel ",
        activationFlag = 127,
        activationValue = 1,
        ownCoalition = coalition.side.RED,
        enemyCoalition = coalition.side.BLUE,
     ...
     { -- HELIS
        name = "PATRULLA_IRAQ_HELIS",
        templates = { "Patrol_IA_IRAQ_1_HELIS", "Patrol_IA_IRAQ_2_HELIS"},
        clonePrefix = "IRAQ hel ",
        activationFlag = 100,
        activationValue = 1,
        ownCoalition = coalition.side.RED,
        enemyCoalition = coalition.side.BLUE,
     ...
     { -- HELIS
        name = "PATRULLA_RUSSIA_HELIS",
        templates = { "Patrol_IA_RUSSIA_1_HELIS", "Patrol_IA_RUSSIA_2_HELIS"},
