...
local PATROL_DEFINITIONS = {
    ...
    { --AVIONES
        ...
        enemyUnitIndex = 1,
        monitorUnitIndex = 1,
        detectionRange = 90 * NM_TO_METERS,
    ...
    { --AVIONES
        name = "PATRULLA_RUSSIA_02",
        templates = { "Patrol_IA_RUSSIA_3", "Patrol_IA_RUSSIA_4", "Patrol_IA_RUSSIA_5" },
        clonePrefix = "RUSSIA air ",
        activationFlag = 114,
        activationValue = 1,
        ownCoalition = coalition.side.RED,
    ...
    { --helis
        name = "PATRULLA_RUSSIA_03",
        templates = { "Patrol_IA_RUSSIA_3_HELIS", "Patrol_IA_RUSSIA_4_HELIS"},
    ...
    { --AVIONES
        name = "PATRULLA_RUSSIA_03",
        templates = { "Patrol_IA_RUSSIA_6", "Patrol_IA_RUSSIA_7"},
        clonePrefix = "RUSSIA air ",
        activationFlag = 115,
        activationValue = 1,
        ownCoalition = coalition.side.RED,
     ...
     { --AVIONES
        name = "PATRULLA_RUSSIA_04",
        templates = { "Patrol_IA_RUSSIA_8", "Patrol_IA_RUSSIA_9", "Patrol_IA_RUSSIA_10"},
        clonePrefix = "RUSSIA air ",
        activationFlag = 105,
        activationValue = 1,
        ownCoalition = coalition.side.RED,
    ...
    { --AVIONES
        name = "PATRULLA_RUSSIA_05",
        templates = { "Patrol_IA_RUSSIA_11", "Patrol_IA_RUSSIA_12", "Patrol_IA_RUSSIA_13"},
        clonePrefix = "RUSSIA air ",
        activationFlag = 105,
        activationValue = 1,
        ownCoalition = coalition.side.RED,
    ...
    { --AVIONES
        name = "PATRULLA_RUSSIA_06",
        templates = { "Patrol_IA_RUSSIA_11_HELIS", "Patrol_IA_RUSSIA_12_HELIS"},
        clonePrefix = "RUSSIA hel ",
        activationFlag = 105,
        activationValue = 1,
        ownCoalition = coalition.side.RED,
