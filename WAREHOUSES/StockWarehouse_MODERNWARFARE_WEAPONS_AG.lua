...
tipoAviones["FUEL-TANK-PACK"] = {
    ...
    tanques = {
        ["Fuel Tank Ft600"]  = {ws = {1, 3, 43, 103}, cantidad = 10},
        ["Fuel Tank 300 Gallons"]  = {ws = {1, 3, 43, 2740}, cantidad = 10},
        ["AJS External-tank 1013kg fuel"]  = {ws = {1, 3, 43, 294}, cantidad = 10},
        ["Aero 1D 300 Gallons Fuel Tank"]  = {ws = {1, 3, 43, 1572}, cantidad = 10},
        ["Aero 1D 300 Gallons Fuel Tank2"]  = {ws = {1, 3, 43, 2951}, cantidad = 10},
        ["Fuel tank 610 Gal"]  = {ws = {1, 3, 43, 10}, cantidad = 16}, 
        ["Fuel tank 610 Gal2"]  = {ws = {1, 3, 43, 1715}, cantidad = 16},
        ["F-5 275Gal Fuel tank"]  = {ws = {1, 3, 43, 36}, cantidad = 10},
        ...
        ["RPL 541 2000 Liters Fuel Tank"]  = {ws = {1, 3, 43, 604}, cantidad = 10},
        ["RPL 541 2000 Liters Fuel Tank2"]  = {ws = {1, 3, 43, 603}, cantidad = 10},
        ["RPL 522 1300 Liters Fuel Tank"]  = {ws = {1, 3, 43, 605}, cantidad = 10},
        ["Fuel Tank 800 L (21)"]  = {ws = {1, 3, 43, 14}, cantidad = 10},
        ["Fuel Tank 800 L WING"]  = {ws = {1, 3, 43, 54}, cantidad = 10},
        ["RPL201 Pylon Fuel Tank (2310 / Usable)"]  = {ws = {1, 3, 43, 1470}, cantidad = 10},
        ...
        ["800L Tank"]  = {ws = {1, 3, 43, 465}, cantidad = 10},
        ["Fuel Tank 1400L"]  = {ws = {1, 3, 43, 2894}, cantidad = 10},
        ["Fuel Tank 1400L2"]  = {ws = {1, 3, 43, 17}, cantidad = 10},
        ["Fuel Tank 230 Gal"]  = {ws = {1, 3, 43, 1056}, cantidad = 10},
        ["Fuel tank PTB-450"]  = {ws = {1, 3, 43, 855}, cantidad = 10}
    }
}
