...
------------------------------------TANKS HEAVY
ctld.i18n["en"]["Sherman FF M4A4"] = ""
ctld.i18n["en"]["Sherman M4"] = ""
ctld.i18n["en"]["Tractor M4"] = ""
ctld.i18n["en"]["Greyhound M8"] = ""
ctld.i18n["en"]["M10 tank destroyer"] = ""
ctld.i18n["en"]["M12 Gun Motor Carriage"] = ""
ctld.i18n["en"]["T 90"] = ""
ctld.i18n["en"]["T 80UD"] = ""
ctld.i18n["en"]["T 72B3"] = ""
ctld.i18n["en"]["T 72B"] = ""
...
-------------------------------------------------------
ctld.i18n["en"]["M1 37mm"] = ""
ctld.i18n["en"]["bofors 40mm AAA"] = ""
ctld.i18n["en"]["Roland ADS"] = ""
ctld.i18n["en"]["Roland Radar"] = ""
ctld.i18n["en"]["M45 Quadmount AAA"] = ""
...
------------------------------------TANKS HEAVY
ctld.i18n["en"]["Sherman FF M4A4 - $ 6,500,000"] = ""
ctld.i18n["en"]["Sherman M4 - $ 5,000,000"] = ""
ctld.i18n["en"]["Tractor M4 - $ 2,500,000"] = ""    
ctld.i18n["en"]["Greyhound M8 - $ 9,000,000"] = ""
ctld.i18n["en"]["M10 tank destroyer - $ 4,500,000"] = ""
ctld.i18n["en"]["M12 Gun Motor Carriage - $ 4,500,000"] = ""
...
------------------------------------------------------------------------ AAA
ctld.i18n["en"]["M1 37mm - $ 1,000,000"] = ""
ctld.i18n["en"]["bofors 40mm AAA - $ 1,200,000"] = ""
ctld.i18n["en"]["Roland System - $ 4,000,000"] = ""
ctld.i18n["en"]["M45 Quadmount AAA - $ 2,000,000"] = ""
...
ctld.numberOfTroops = 0 -- default number of troops to load on a transport heli or C-130
...
ctld.vehiclesForTransportBLUE = { "M4_Tractor", "M8_Greyhound" } -- vehicles to load onto c130 - Alternatives {"M1128 Stryker MGS","M1 37mm"}
ctld.vehiclesWeight = {
    ["T-90"] = 200,
    ["Strela-10M3"] = 200,
    ["M4_Tractor"] = 500,
...
ctld.pickupZones = {
    { "pickzone1", "red", -1, "yes", 2 },
    { "pickzone2", "red", -1, "yes", 2 },--TARAWA
    { "pickzone3", "red", -1, "yes", 2 },--TARAWA
    { "pickzone4", "none", -1, "yes", 0 },--TARAWA
    { "pickzone5", "none", -1, "yes", 0 },--TARAWA
    { "pickzone6", "none", -1, "yes", 0 },--TARAWA
    { "pickzone7", "none", -1, "yes", 0 },--BLUE COMMAND CENTER
    ...
    { "pickzone29", "none", -1, "yes", 0 },
    { "pickzone30", "none", -1, "yes", 0 }, --
...
ctld.unitActions = {
    ...
    --%%%%% WARBIRDS %%%%%
        ...
        ["TF-51D"] = {crates=true, troops=false},
        ["LA-7"] = {crates=true, troops=false},
}
...
ctld.spawnableCrates = {
    ...
    ["Vehiculos de Combate"] = {
        ...
        --Heavy Combat BLUE
        { weight = 1000.05, desc = ctld.i18n_translate("Sherman FF M4A4"), unit="M1A2C_SEP_V3", side = 0, cratesRequired = 2 },
        { multiple = {1000.05, 1000.05, 1000.05, 1000.05}, desc = ctld.i18n_translate("Sherman FF M4A4 - $ 6,500,000"), side = 2 }, -- Sherman FF
        { weight = 1007.01, desc = ctld.i18n_translate("Sherman M4"), unit="M4_Sherman", side = 0, cratesRequired = 2 },
        { multiple = {1007.01, 1007.01}, desc = ctld.i18n_translate("Sherman M4 - $ 5,000,000"), side = 2 }, -- Sherman
        { weight = 1007.02, desc = ctld.i18n_translate("Tractor M4"), unit="M4_Tractor", side = 0, cratesRequired = 2 },
        { multiple = {1007.02, 1007.02}, desc = ctld.i18n_translate("Tractor M4 - $ 2,500,000"), side = 2 }, -- Tractor
        { weight = 1007.03, desc = ctld.i18n_translate("Greyhound M8"), unit="M8_Greyhound", side = 0, cratesRequired = 2 },
        { multiple = {1007.03, 1007.03}, desc = ctld.i18n_translate("Greyhound M8 - $ 9,000,000"), side = 2 }, -- Greyhound M8
        { weight = 1007.04, desc = ctld.i18n_translate("M10 tank destroyer"), unit="M10_GMC", side = 0, cratesRequired = 2 },
        { multiple = {1007.04, 1007.04}, desc = ctld.i18n_translate("M10 tank destroyer - $ 4,500,000"), side = 2 }, -- Merkava
        { weight = 1007.04, desc = ctld.i18n_translate("M12 Gun Motor Carriage"), unit="M12_GMC", side = 0, cratesRequired = 2 },
        { multiple = {1007.14, 1007.14}, desc = ctld.i18n_translate("M12 Gun Motor Carriage - $ 4,500,000"), side = 2 }, -- Merkava
        --Heavy Combat RED
    ...
    ["AAA"] = {
        --- BLUE
        { weight = 1003.01, desc = ctld.i18n_translate("M1 37mm"), unit = "M1_37mm", side = 0, cratesRequired = 2 },
        { multiple = {1003.01, 1003.01}, desc = ctld.i18n_translate("M1 37mm - $ 1,000,000"), side=2 },
        { weight = 1003.02, desc = ctld.i18n_translate("bofors 40mm AAA"), unit = "bofors40", side = 0, cratesRequired = 2 },
        { multiple = {1003.02, 1003.02}, desc = ctld.i18n_translate("bofors 40mm AAA - $ 1,200,000"), side=2 },
        ...
        { weight = 1003.04, desc = ctld.i18n_translate("M45 Quadmount AAA"), unit = "M45_Quadmount", side = 0, cratesRequired = 2 },
        { multiple = {1003.04, 1003.04}, desc = ctld.i18n_translate("M45 Quadmount AAA - $ 2,000,000"), side=2 },
...
function ctld.spawnCrate(_arguments, bypassCrateWaitTime)
    ...
    local _status, _err = pcall(function(_args)
        ...
        if _crateType ~= nil and _heli ~= nil and ctld.inAir(_heli) == false then
            ...
            local continuar = CTLD_ECONOMIA_HOOK(_args, _heli, _crateType)
...
function ctld.spawnDroppedGroup(_point, _details, _spawnBehind, _maxSearch)
    ...
    if _spawnBehind == false then
        ...
        local _xOffset = math.cos(_angle) * -100
        local _yOffset = math.sin(_angle) * -100
                                        ...
                                        if not(_crate.multiple) or ctld.enableAllCrates then
                                            ...
                                            if not isJTAC or (isJTAC and ctld.JTAC_dropEnabled) then
                                                if _crate.side == nil or (_crate.side == _unit:getCoalition()) then
                                                    ...
                                                    if HDEV_CTLD_Economy_getDisplayPrice then
                                                    local _displayPrice = HDEV_CTLD_Economy_getDisplayPrice(_crate)
                                                            if _displayPrice then
                                                                _crateRadioMsg = _crateRadioMsg .. " - " .. _displayPrice
                                                            end
                                                        end
