...
AIP.manualCapabilities = {
    ...
    ["Banak"] = { aviones = true, helis = true, c130 = false, armas = true },-- CAP
    ["Rovaniemi"] = { aviones = true, helis = true, c130 = true, armas = false }, --CAP
    ["Kemi Tornio"] = { aviones = true, helis = true, c130 = false, armas = false }, --CAP
    ["Vuojarvi"] = { aviones = true, helis = false, c130 = false, armas = false },--CAP
    ["Kiruna"] = { aviones = true, helis = true, c130 = true, armas = false }, --CAP
    ["Severomorsk-3"] = { aviones = true, helis = true, c130 = true, armas = false },--CAP
    ["Bodo"] = { aviones = true, helis = true, c130 = true, armas = true }, --CAP
    ["Severomorsk-1"] = { aviones = true, helis = true, c130 = true, armas = false },--CAP
    ["Olenya"] = { aviones = true, helis = true, c130 = true, armas = false }, --CAP
    ["Monchegorsk"] = { aviones = true, helis = true, c130 = true, armas = true }, --CAP
    ["Jokkmokk"] = { aviones = true, helis = false, c130 = false, armas = false }, --CAP
    ["Murmansk International"] = { aviones = true, helis = true, c130 = true, armas = false },--CAP
    ["Kalixfors"] = { aviones = false, helis = true, c130 = false, armas = true }, --CAP
    ["Kirkenes"] = { aviones = true, helis = true, c130 = true, armas = false }, --CAP
    ["Kallax"] = { aviones = true, helis = true, c130 = true, armas = false }, --CAP
    ["Kuusamo"] = { aviones = true, helis = true, c130 = false, armas = false }, --CAP
    ["Vidsel"] = { aviones = true, helis = true, c130 = true, armas = false }, --CAP
    ["Ivalo"] = { aviones = true, helis = true, c130 = true, armas = true }, -- CAP
    ["Alakurtti"] = { aviones = true, helis = true, c130 = false, armas = false }, --CAP
    ["Andoya"] = { aviones = true, helis = true, c130 = true, armas = true }, --CAP
    ["Bardufoss"] = { aviones = true, helis = true, c130 = true, armas = false }, --CAP
    ["Kittila"] = { aviones = true, helis = true, c130 = false, armas = false },--CAP
    ["Hosio"] = { aviones = true, helis = false, c130 = false, armas = false }, --CAP
    ["Alta"] = { aviones = true, helis = true, c130 = false, armas = true }, --CAP
    ...
    ["Kalevala"] = { aviones = true, helis = true, c130 = false, armas = false }, --CAP
    ["Afrikanda"] = { aviones = true, helis = true, c130 = false, armas = false },--CAP
    ["Boden Heli Base"] = { aviones = false, helis = true, c130 = false, armas = false }, --CAP
    ["Hemavan"] = { aviones = true, helis = false, c130 = false, armas = true }, --CAP
    ["Arvidsjaur"] = { aviones = true, helis = true, c130 = true, armas = false }, --CAP
